...
{{WRAPPER}} .mgpc-pcarousel .swiper-rtl .swiper-button-next i,
{{WRAPPER}} .mgpc-pcarousel .swiper-button-next i,
{{WRAPPER}} .mgpc-pcarousel .swiper-rtl .swiper-button-prev i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgpc-pcarousel .swiper-button-prev i,
{{WRAPPER}} .mgpc-pcarousel .swiper-rtl .swiper-button-next i,
{{WRAPPER}} .mgpc-pcarousel .swiper-button-next i,
{{WRAPPER}} .mgpc-pcarousel .swiper-rtl .swiper-button-prev i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgpc-pcarousel .swiper-button-prev svg,
{{WRAPPER}} .mgpc-pcarousel .swiper-rtl .swiper-button-next svg,
{{WRAPPER}} .mgpc-pcarousel .swiper-button-next svg,
{{WRAPPER}} .mgpc-pcarousel .swiper-rtl .swiper-button-prev svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    ?>
        <div class="mgpde-card-text mgpdeg-card-text mgp-text-style<?php echo esc_attr($mgpcar_product_style); ?>">
            ...
            <?php if ($mgpcar_show_title == 'yes') : ?>
                <a class="mgpde-ptitle-link" href="<?php the_permalink(); ?>">
                    ...
                    printf(
                        ...
                        tag_escape( mprd_validate_html_tag($mgpcar_title_tag) ),
            ...
            <?php if ($mgpcar_desc_show) : ?>
                <p><?php echo esc_html(wp_trim_words(get_the_content(), $mgpcar_crop_desc, '...')); ?></p>
            <?php endif; ?>
