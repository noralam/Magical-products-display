...
*/
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mgptcar-car-items.swiper-horizontal>.swiper-pagination-bullets, {{WRAPPER}} .mgptcar-car-items .swiper-pagination-custom, {{WRAPPER}} .mgptcar-car-items .swiper-pagination-fraction' => 'bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .mgptcar-car-items.swiper-vertical>.swiper-pagination-bullets' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .mgptcar-car-items.swiper-horizontal>.swiper-pagination-bullets .swiper-pagination-bullet' => 'margin-right: calc({{SIZE}}{{UNIT}} / 2); margin-left: calc({{SIZE}}{{UNIT}} / 2);',
					'{{WRAPPER}} .mgptcar-car-items.swiper-vertical>.swiper-pagination-bullets .swiper-pagination-bullet' => 'margin-top: calc({{SIZE}}{{UNIT}} / 2); margin-bottom: calc({{SIZE}}{{UNIT}} / 2);',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .mgptcar-car-items.swiper-horizontal>.swiper-pagination-bullets, .swiper-pagination-custom, {{WRAPPER}} .mgptcar-car-items .swiper-pagination-fraction' => 'text-align: {{VALUE}}'
				]
			]
		);
		$this->add_control(
...
{{WRAPPER}} .mgptcar-car-items.swiper-rtl .swiper-button-next i,
{{WRAPPER}} .mgptcar-car-items.swiper-rtl .swiper-button-next i,
{{WRAPPER}} .mgpd-testimonial-carousel .swiper-button-next i,
{{WRAPPER}} .mgptcar-car-items.swiper-rtl .swiper-button-prev i,
{{WRAPPER}} .mgptcar-car-items.swiper-rtl .swiper-button-prev i' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .mgpd-testimonial-carousel .swiper-button-next svg,{{WRAPPER}} .mgpd-testimonial-carousel .swiper-button-prev svg,
{{WRAPPER}} .mgptcar-car-items.swiper-rtl .swiper-button-prev svg,
{{WRAPPER}} .mgptcar-car-items.swiper-rtl .swiper-button-prev svg' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mgptcar-car-items .swiper-button-prev, {{WRAPPER}} .mgptcar-car-items .swiper-rtl .swiper-button-next' => 'left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .mgptcar-car-items .swiper-button-next,{{WRAPPER}} .mgptcar-car-items .swiper-rtl .swiper-button-prev' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
