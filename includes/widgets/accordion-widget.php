...
?>
        ...
        <div class="accordion mgaccordion mg-<?php echo esc_attr($settings['mpdac_style']); ?> <?php echo esc_attr($mpdac_excolor); ?>" id="mpdAccordion<?php echo esc_attr($mpdac_rand); ?>">
